...
class CalculatorView: UIView {
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        displayView.font = UIFont.boldSystemFontOfSize(unitHeight * 3 / 4)
        ...
        for i in 0...8 {
            ...
            digitalButton.backgroundColor = UIColor.grayColor()
            digitalButton.tag = i + 1
            digitalButton.setTitle("\(i + 1)", forState: UIControlState.Normal)
            digitalButton.setTitleColor(UIColor.blackColor(), forState: UIControlState.Normal)
        ...
        //收支转换按键
        let attributedString = NSMutableAttributedString(string: "收/支")
        attributedString.addAttributes([NSFontAttributeName: UIFont.systemFontOfSize(12), NSForegroundColorAttributeName: UIColor.orangeColor()], range:NSMakeRange(0, 1))
        attributedString.addAttributes([NSFontAttributeName: UIFont.systemFontOfSize(12), NSForegroundColorAttributeName: UIColor.blueColor()], range: NSMakeRange(1, 1))
        attributedString.addAttributes([NSFontAttributeName: UIFont.systemFontOfSize(10), NSForegroundColorAttributeName: UIColor.greenColor()], range: NSMakeRange(2, 1))
        ...
        zeroButton.backgroundColor = UIColor.grayColor()
        ...
        zeroButton.setTitleColor(UIColor.blackColor(), forState: UIControlState.Normal)
        ...
        dotButton.setTitleColor(UIColor.blackColor(), forState: UIControlState.Normal)
